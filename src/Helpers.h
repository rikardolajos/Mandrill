...
namespace Mandrill
{
    ...
    /// creating an object.
    /// </summary>
    class MANDRILL_API Helpers{public :
                                   /// <summary>
...
/// (optional)</param>
inline static void cmdEnd(ptr<Device> pDevice, VkCommandBuffer cmd, const std::vector<VkSemaphore>& waitSemaphores = {},
...
inline static uint32_t findMemoryType(ptr<Device> pDevice, uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
...
inline static VkFormat findSupportedFormat(ptr<Device> pDevice, std::vector<VkFormat> candidates, VkImageTiling tiling,
